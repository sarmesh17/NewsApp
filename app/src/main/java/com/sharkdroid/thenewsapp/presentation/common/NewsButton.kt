...
import com.sharkdroid.thenewsapp.ui.theme.WhiteGrey
...
fun NewsTextButton(
    ...
    TextButton(onClick =  onClick ) {
        Text(text = text, style = MaterialTheme.typography.labelMedium.copy(fontWeight = FontWeight.SemiBold), color = WhiteGrey)
    }
